...
// import { cn } from "../utils/cn"; // Ensure you have your cn utility imported
...
//   // 1. Fetch the Allowed Departments on Mount
//   useEffect(() => {
...
//   // 2. Fetch Categories whenever the selected department changes
...
//           <Card className="shadow-sm border-slate-200/60 rounded-2xl bg-white overflow-hidden">
//             <CardHeader className="bg-slate-50/50 border-b border-slate-100 py-5 px-5">
...
//               </CardTitle>
//             </CardHeader>
//             <div className="p-3 flex flex-col gap-1.5 max-h-[60vh] overflow-y-auto custom-scrollbar">
...
//                     className={cn(
//                       "flex items-center justify-between px-4 py-3 rounded-xl text-sm transition-all duration-200 text-left",
//                       selectedDept === dept
//                         ? "bg-indigo-50/80 text-indigo-700 font-bold ring-1 ring-inset ring-indigo-500/20 shadow-sm"
...
//           {selectedDept ? (
//             <>
//               {/* Sleek Add Category Bar */}
//               <div className="bg-white border border-slate-200/80 shadow-sm rounded-2xl p-2 flex items-center transition-all focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-500">
...
//                     className="flex-1 bg-transparent h-11 text-sm font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none"
//                   />
//                   <Button
//                     type="submit"
//                     disabled={!newCategoryName.trim()}
//                     className="rounded-xl px-6 bg-slate-900 hover:bg-slate-800 text-white font-medium shadow-sm transition-all disabled:opacity-50"
//                   >
...
//                     Fetching active routing tree...
//                   </p>
//                 </div>
//               ) : categories.length === 0 ? (
//                 <div className="py-24 text-center border border-dashed border-slate-300 rounded-2xl bg-slate-50/50 flex flex-col items-center justify-center">
...
//                     <Card
//                       key={category.id}
//                       className="shadow-sm border-slate-200/60 rounded-2xl overflow-hidden flex flex-col bg-white transition-all hover:shadow-md hover:border-indigo-100"
//                     >
//                       {/* Category Header */}
//                       <div className="bg-slate-50/50 border-b border-slate-100 px-5 py-4 flex items-center justify-between shrink-0">
//                         <h3 className="font-bold text-slate-900 text-[15px] flex items-center gap-3 tracking-tight">
//                           <div className="p-1.5 bg-indigo-100 text-indigo-600 rounded-lg ring-1 ring-inset ring-indigo-500/20 shadow-sm">
//                             <Layers size={16} />
//                           </div>
//                           {category.name}
//                         </h3>
...
//                           className="text-slate-400 hover:text-red-600 hover:bg-red-50 p-2 rounded-lg transition-colors group"
...
//                       {/* Subcategories (Tags Layout) */}
//                       <div className="flex-1 p-5 bg-white">
//                         {category.subcategories.length === 0 ? (
//                           <div className="flex items-center gap-2 text-xs text-slate-400 font-medium bg-slate-50 border border-slate-100 rounded-lg p-3">
//                             <AlertCircle size={14} /> No subcategories assigned
//                             yet.
//                           </div>
//                         ) : (
...
//                               <div
//                                 key={sub.id}
//                                 className="group inline-flex items-center gap-2 bg-slate-50 border border-slate-200/60 text-slate-700 text-xs font-semibold pl-2.5 pr-1 py-1.5 rounded-lg transition-all hover:border-indigo-200 hover:bg-indigo-50/30 hover:text-indigo-900"
//                               >
//                                 <Tag
//                                   size={12}
...
//                                   }
//                                   className="text-slate-400 opacity-0 group-hover:opacity-100 hover:bg-red-100 hover:text-red-600 p-1 rounded-md transition-all focus:opacity-100"
...
//                             }}
//                             className="w-full h-10 rounded-xl border border-slate-200/80 pl-3 pr-20 text-sm font-medium focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none bg-white shadow-sm transition-all"
//                           />
//                           <button
...
//                             }
//                             className="absolute right-1.5 top-1/2 -translate-y-1/2 h-7 px-3 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold hover:bg-indigo-600 hover:text-white disabled:opacity-0 transition-all duration-200"
//                           >
//                             Add
//                           </button>
//                         </div>
