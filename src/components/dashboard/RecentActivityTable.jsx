...
//   // Reusing our consistent status icons
...
//   // Reusing our consistent priority colors
...
//         <h3 className="text-lg font-bold text-slate-900">Recent Ticket Activity</h3>
//         <Button variant="ghost" size="sm" onClick={() => navigate('/tickets')} className="text-[var(--tenant-primary,#4f46e5)]">
...
//                       <span className="capitalize">{ticket.status.replace('_', ' ').toLowerCase()}</span>
//                     </div>
//                   </td>
//                   <td className="px-6 py-4 text-slate-500">
//                     {new Intl.DateTimeFormat('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: 'numeric' }).format(new Date(ticket.created_at))}
//                   </td>
//                   <td className="px-6 py-4 text-right">
//                     {/* Quick Action Button */}
//                     <Button variant="secondary" size="sm" onClick={() => navigate(`/tickets/${ticket.id}`)}>
//                       View
//                     </Button>
//                   </td>
//                 </tr>
